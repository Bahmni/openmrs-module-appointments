...
public class AppointmentsEventRecordsConstants {
    ...
    public static final String RAISE_EVENT_GLOBAL_PROPERTY = "bahmnievents.publish.eventsForAppointments";
    public static final String URL_PATTERN_GLOBAL_PROPERTY = "bahmnievents.event.urlPatternForAppointments";
    ...
    public static final String RECURRING_URL_PATTERN_GLOBAL_PROPERTY = "bahmnievents.event.urlPatternForRecurringAppointments";
    ...
    public static final String SERVICE_RAISE_EVENT_GLOBAL_PROPERTY = "bahmnievents.publish.eventsForAppointmentService";
    public static final String SERVICE_URL_PATTERN_GLOBAL_PROPERTY = "bahmnievents.event.urlPatternForAppointmentService";
