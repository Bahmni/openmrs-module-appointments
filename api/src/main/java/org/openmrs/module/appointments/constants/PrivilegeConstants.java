...
public class PrivilegeConstants {
    ...
    public static final String ADD_APPOINTMENT_UNAVAILABILITY = "Add Appointment Unavailability";
    public static final String GET_APPOINTMENT_UNAVAILABILITY = "Get Appointment Unavailability";
    public static final String DELETE_APPOINTMENT_UNAVAILABILITY = "Delete Appointment Unavailability";
}